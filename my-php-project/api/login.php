    ...
    <style>
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.7)),
                        url('/assets/apple.jpg') center/cover no-repeat fixed;
            display: flex;
            align-items: center;
...
<div class="login-card">
    ...
    <div class="text-center mt-4">
        <p>Chưa có tài khoản? <a href="/api/register.php" class="text-primary fw-bold text-decoration-none">Đăng ký ngay</a></p>
    </div>
    ...
    <div class="admin-box">
        ...
        <a href="/api/register.php?admin=1" class="btn btn-admin">
