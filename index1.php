...
{
    mysqli_query($link,"insert into table1 values (NULL,'$_POST[name]' ,'$_POST[brand]','$_POST[price]')");
   ?>
...
{
    mysqli_query($link,"update table2 set name='$_POST[brand]'where name='$_POST[name]'");
    ?>
    <script type="text/javascript">
        window.location.href=window.location.href;
    </script>
